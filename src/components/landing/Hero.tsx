    ...
    <section className="intro">
      <div className="intro-body">
        <div className="sonar-wrapper animate-float" style={{marginBottom: '20px'}}>
          ...
          <span className="eyebrow-badge">Systematic Swing Trading · IDX</span>
        </div>
        <h1 className="display-text">Trade like a system.<br /><span className="accent">Even if you're starting today.</span></h1>
        <p>
