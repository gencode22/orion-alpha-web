  ...
  <div className="landing-container">
    ...
    <section className="audience-section fade-up" aria-labelledby="audience-title">
      <div className="section-head">
        ...
        <h2 id="audience-title">Made for traders <em>who want a system, not noise</em></h2>
        <p>Whether you're learning your first setup or trading systematically for years, Orion meets you where you are.</p>
      </div>
    ...
    <section className="faq-section fade-up" aria-labelledby="faq-title">
      ...
      <div className="faq-grid">
        ...
        <details className="faq-item">
          ...
          <div className="faq-body">
            Paid plans are currently active on Telegram only. Discord runs in demo mode (5 popular stocks for technical commands; backtest/FA/scan blocked). The web dashboard (<Link href="/app">/app</Link>) also runs in demo mode. Cross-platform tier integration is on the roadmap.
          </div>
        </details>
      </div>
    </section>
    ...
    {/*  ── Final CTA ──  */}
    <section className="pricing-final fade-up">
      <h2>Your edge in IDX is one click away.</h2>
      <p>Start with Free — 3 signals/day, full market scan, regime read. No credit card. No expiry. Upgrade only when you're ready.</p>
