    ...
    <div className="landing">
      ...
      <div className="landing-container">
        ...
        <section className="about-hero">
          ...
          <h1 className="display-text">A name built<br /><span className="accent">on purpose.</span></h1>
          <p className="lede">Every product name carries intent. Here's what ours means — and why it shapes everything we build.</p>
        </section>
        ...
        <section className="outcomes-section fade-up">
          ...
          <div className="outcomes-grid">
            <div className="outcome-card glass-card">
        ...
        <section className="about-cta fade-up glass-card">
          <h2 className="display-text">Hunt smarter. Start free.</h2>
