      ...
      <div className="landing-container">
        ...
        <div className="privacy-section">
          ...
          <ul>
            ...
            <li><strong>Telegram</strong> — bot platform. Messages are processed per <a href="https://telegram.org/privacy" target="_blank" rel="noopener noreferrer">Telegram&rsquo;s Privacy Policy</a>.</li>
            <li><strong>Discord</strong> — community server only (no bot deployed). Membership is governed by <a href="https://discord.com/privacy" target="_blank" rel="noopener noreferrer">Discord&rsquo;s Privacy Policy</a>.</li>
            ...
            <li><strong>Google Gemini / Ollama</strong> — AI analysis (owner account only). Messages sent to AI agents may be processed by Google&rsquo;s API.</li>
          </ul>
        </div>
        ...
        <div className="privacy-section">
          ...
          <ul>
            ...
            <li>GA4 analytics data is retained per Google&rsquo;s default retention settings (14 months)</li>
        ...
        <div className="privacy-section">
          ...
          <p>To opt out of GA4 analytics, use the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer">Google Analytics Opt-out Browser Add-on</a> or enable &ldquo;Do Not Track&rdquo; in your browser settings.</p>
        </div>

        <div className="privacy-section">
          <h2>7. Cookies</h2>
          <p>This website uses one first-party cookie (<code>orion-theme</code>) to remember your dark/light mode preference. No tracking cookies are set by us directly. Google Analytics 4 may set cookies per Google&rsquo;s standard behavior.</p>
        </div>

        <div className="privacy-section">
          <h2>8. Changes to This Policy</h2>
          <p>We may update this policy as the service evolves. The &ldquo;last updated&rdquo; date at the top of this page reflects the most recent revision. Continued use of Orion Alpha after changes constitutes acceptance of the updated policy.</p>
        </div>
